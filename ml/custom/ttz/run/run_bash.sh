...
rm -f /project/atlas/users/mveldijk/MLHEPsimtest/MLHEPsim/ml/custom/ttz/run/mafmademog*
rm -f /project/atlas/users/mveldijk/MLHEPsimtest/MLHEPsim/ml/custom/ttz/run/condor/mveldijk/condorsub/*
...
condorsub -J mafmademog -q medium -n 1 -g 1 -m 12000 \
"source /etc/profile && \
...
cd /project/atlas/users/mveldijk/MLHEPsimtest/MLHEPsim && \
python -m ml.custom.ttz.main_flows"

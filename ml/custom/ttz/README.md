# ttZ Flow Model Training

This directory contains scripts for training normalizing flow models on ttZ physics data using PyTorch Lightning and Hydra for configuration management.
...
1. **ttzNpyProcessor**: Loads and processes raw ttZ data from `.npy` files
2. **ttzFeatureSelector**: Selects relevant features based on configuration
...
3. **Visualizations**: Stored in `ml/custom/ttz/metrics/`
   - Density plots
